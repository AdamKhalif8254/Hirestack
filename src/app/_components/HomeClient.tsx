        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:block">
            <ul className="flex space-x-8">
              {['Home', 'Features', 'Jobs', 'Contact'].map((item, index) => (
                <li key={index} className="group relative">
                  ...
                  <span className="absolute bottom-0 left-0 h-0.5 w-full scale-x-0 transform bg-blue-400 transition-transform duration-300 group-hover:scale-x-100"></span>
                </li>
              ))}
            </ul>
          </nav>

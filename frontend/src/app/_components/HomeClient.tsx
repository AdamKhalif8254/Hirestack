          ...
          >
            ...
            >
              {jobData.map((job) => (
                <div
                  key={job.id}
                  className="group relative transform overflow-hidden rounded-lg bg-gray-800 bg-opacity-50 p-6 shadow-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
                >
                  <div className="card-content relative z-10 space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>
                        {job.employees} previous employees on LinkedIn
                      </span>
                    </div>
                    <div>
